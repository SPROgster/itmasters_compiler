...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{14,10,32,14,3,4,5,61,6,65,7,69,11,75},new int[]{-15,5,-8,80,-13,9,-7,18,-3,19,-16,59,-9,60,-10,64,-11,68,-12,74});
    states[5] = new State(new int[]{4,6,10,7});
    states[6] = new State(-17);
    states[7] = new State(new int[]{14,10,32,14,3,4,5,61,6,65,7,69,11,75},new int[]{-8,8,-13,9,-7,18,-3,19,-16,59,-9,60,-10,64,-11,68,-12,74});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(new int[]{32,14},new int[]{-14,11,-3,17});
    states[11] = new State(new int[]{12,12,13,15});
    states[12] = new State(new int[]{32,14},new int[]{-3,13});
    states[13] = new State(-16);
    states[14] = new State(-12);
    states[15] = new State(new int[]{32,14},new int[]{-3,16});
    states[16] = new State(-14);
    states[17] = new State(-13);
    states[18] = new State(-6);
    states[19] = new State(new int[]{9,20});
    states[20] = new State(new int[]{32,14,30,31,31,32,29,33,19,53,27,57,28,58},new int[]{-6,21,-2,22,-1,23,-4,42,-5,41,-3,30});
    states[21] = new State(-15);
    states[22] = new State(-23);
    states[23] = new State(new int[]{21,24,15,26,16,37,22,43,23,45,24,47,25,49,26,51,4,-24,10,-24,8,-24,20,-24});
    states[24] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,25,-4,42,-5,41,-3,30});
    states[25] = new State(new int[]{15,26,16,37,4,-25,10,-25,8,-25,20,-25,14,-25,32,-25,3,-25,5,-25,6,-25,7,-25,11,-25});
    states[26] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-4,27,-5,41,-3,30});
    states[27] = new State(new int[]{17,28,18,39,21,-35,15,-35,16,-35,22,-35,23,-35,24,-35,25,-35,26,-35,4,-35,10,-35,8,-35,20,-35,14,-35,32,-35,3,-35,5,-35,6,-35,7,-35,11,-35});
    states[28] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-5,29,-3,30});
    states[29] = new State(-38);
    states[30] = new State(-40);
    states[31] = new State(-41);
    states[32] = new State(-42);
    states[33] = new State(-43);
    states[34] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,35,-4,42,-5,41,-3,30});
    states[35] = new State(new int[]{20,36,15,26,16,37});
    states[36] = new State(-44);
    states[37] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-4,38,-5,41,-3,30});
    states[38] = new State(new int[]{17,28,18,39,21,-36,15,-36,16,-36,22,-36,23,-36,24,-36,25,-36,26,-36,4,-36,10,-36,8,-36,20,-36,14,-36,32,-36,3,-36,5,-36,6,-36,7,-36,11,-36});
    states[39] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-5,40,-3,30});
    states[40] = new State(-39);
    states[41] = new State(-37);
    states[42] = new State(new int[]{17,28,18,39,21,-34,15,-34,16,-34,22,-34,23,-34,24,-34,25,-34,26,-34,4,-34,10,-34,8,-34,20,-34,14,-34,32,-34,3,-34,5,-34,6,-34,7,-34,11,-34});
    states[43] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,44,-4,42,-5,41,-3,30});
    states[44] = new State(new int[]{15,26,16,37,4,-26,10,-26,8,-26,20,-26,14,-26,32,-26,3,-26,5,-26,6,-26,7,-26,11,-26});
    states[45] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,46,-4,42,-5,41,-3,30});
    states[46] = new State(new int[]{15,26,16,37,4,-27,10,-27,8,-27,20,-27,14,-27,32,-27,3,-27,5,-27,6,-27,7,-27,11,-27});
    states[47] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,48,-4,42,-5,41,-3,30});
    states[48] = new State(new int[]{15,26,16,37,4,-28,10,-28,8,-28,20,-28,14,-28,32,-28,3,-28,5,-28,6,-28,7,-28,11,-28});
    states[49] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,50,-4,42,-5,41,-3,30});
    states[50] = new State(new int[]{15,26,16,37,4,-29,10,-29,8,-29,20,-29,14,-29,32,-29,3,-29,5,-29,6,-29,7,-29,11,-29});
    states[51] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,52,-4,42,-5,41,-3,30});
    states[52] = new State(new int[]{15,26,16,37,4,-30,10,-30,8,-30,20,-30,14,-30,32,-30,3,-30,5,-30,6,-30,7,-30,11,-30});
    states[53] = new State(new int[]{32,14,30,31,31,32,29,33,19,53,27,57,28,58},new int[]{-1,54,-2,55,-4,42,-5,41,-3,30});
    states[54] = new State(new int[]{20,36,15,26,16,37,21,24,22,43,23,45,24,47,25,49,26,51});
    ...
    states[61] = new State(new int[]{32,14,30,31,31,32,29,33,19,34},new int[]{-1,62,-4,42,-5,41,-3,30});
    states[62] = new State(new int[]{15,26,16,37,14,10,32,14,3,4,5,61,6,65,7,69,11,75},new int[]{-8,63,-13,9,-7,18,-3,19,-16,59,-9,60,-10,64,-11,68,-12,74});
    states[63] = new State(-18);
    states[64] = new State(-9);
    states[65] = new State(new int[]{32,14,30,31,31,32,29,33,19,53,27,57,28,58},new int[]{-2,66,-1,79,-4,42,-5,41,-3,30});
    states[66] = new State(new int[]{14,10,32,14,3,4,5,61,6,65,7,69,11,75},new int[]{-8,67,-13,9,-7,18,-3,19,-16,59,-9,60,-10,64,-11,68,-12,74});
    states[67] = new State(-19);
    states[68] = new State(-10);
    states[69] = new State(new int[]{32,14,30,31,31,32,29,33,19,53,27,57,28,58},new int[]{-2,70,-1,79,-4,42,-5,41,-3,30});
    states[70] = new State(new int[]{14,10,32,14,3,4,5,61,6,65,7,69,11,75},new int[]{-8,71,-13,9,-7,18,-3,19,-16,59,-9,60,-10,64,-11,68,-12,74});
    states[71] = new State(new int[]{8,72,4,-20,10,-20});
    states[72] = new State(new int[]{14,10,32,14,3,4,5,61,6,65,7,69,11,75},new int[]{-8,73,-13,9,-7,18,-3,19,-16,59,-9,60,-10,64,-11,68,-12,74});
    states[73] = new State(-21);
    states[74] = new State(-11);
    states[75] = new State(new int[]{19,76});
    states[76] = new State(new int[]{32,14,30,31,31,32,29,33,19,53,27,57,28,58},new int[]{-6,77,-2,22,-1,23,-4,42,-5,41,-3,30});
    states[77] = new State(new int[]{20,78});
    states[78] = new State(-22);
    states[79] = new State(new int[]{21,24,15,26,16,37,22,43,23,45,24,47,25,49,26,51});
    ...
    rules[12] = new Rule(-3, new int[]{32});
    ...
    rules[32] = new Rule(-2, new int[]{27});
    rules[33] = new Rule(-2, new int[]{28});
    rules[34] = new Rule(-1, new int[]{-4});
    rules[35] = new Rule(-1, new int[]{-1,15,-4});
    rules[36] = new Rule(-1, new int[]{-1,16,-4});
    rules[37] = new Rule(-4, new int[]{-5});
    rules[38] = new Rule(-4, new int[]{-4,17,-5});
    rules[39] = new Rule(-4, new int[]{-4,18,-5});
    rules[40] = new Rule(-5, new int[]{-3});
    rules[41] = new Rule(-5, new int[]{30});
    rules[42] = new Rule(-5, new int[]{31});
    rules[43] = new Rule(-5, new int[]{29});
    rules[44] = new Rule(-5, new int[]{19,-1,20});
  }
...
{ CurrentSemanticValue.eVal = new BinOpNode(ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].eVal, BinOpType.Plus); }
        break;
      case 36: // num_expr -> num_expr, MINUS, T
